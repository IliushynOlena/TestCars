...
public class TestCar {
        ...
        public void CreateCar(){
            cars=new Car[3];
            CarByYear=new Car[2];
            cars[0]=new Car("Pedgeout","Partner", 2018, "Red", 20000,1);
            cars[1]=new Car("Mazda","5", 2016, "Black", 15000,2);
            cars[2]=new Car("Gilly","CK", 2017, "Black", 12900,3);
            CarByYearAndPrice=new Car("Volkswagen","Passat", 2017, "Black", 12900,3);
            Makes=new String [3];
            Makes[0]="Pedgeout";
            Makes[1]="Mazda";
            Makes[2]="Gilly";//
            CarByYear[0]=new Car("Mazda","A6", 2016, "Black", 15000,2);
